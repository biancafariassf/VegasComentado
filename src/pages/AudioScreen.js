...
function AudioScreen() {
  ...
  //definindo uma função chamada speak que aceita um argumento text
  //Dentro da função, está sendo utilizada a função Speech.speak da API de áudio do Expo para falar o texto fornecido
  // No caso, o idioma está definido como inglês dos Estados Unidos ('en-US').
  const speak = (text) => {
    Speech.speak(text, {
      language: 'en-US',
    });
  ...
  //criando uma string audioText com o valor 'Hello' e, em seguida, chamando a função speak com essa string como argumento
  // Isso fará com que a API de áudio fale a palavra "Hello".
//Se você chamar playAudio1(), a API irá falar a palavra "Hello" no idioma especificado.
  const playAudio1 = () => {
