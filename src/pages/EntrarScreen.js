...
function EntrarScreen() {
  ...
  useLayoutEffect(() => {
    ...
    //este efeito será acionado sempre que navigation mudar.
  }, [navigation]); 

  //Se a variável user existir e for avaliada como verdadeira, o componente Profile é renderizado. Presumivelmente, Profile é um componente que mostra o perfil do usuário
